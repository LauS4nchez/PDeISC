...
export interface ApiTrabajoTrabajo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    capturas: Schema.Attribute.Media<'images' | 'files', true>;
    consigna: Schema.Attribute.RichText & Schema.Attribute.Required;
    creacion: Schema.Attribute.Date & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.RichText & Schema.Attribute.Required;
    finalizado: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
